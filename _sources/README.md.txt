...
<img src="./docs/img/discord.png" width=400 alt="Message in Discord reflecting DAG status">
...
<img src="./docs/img/newrelic.png" width=400 alt="Dashboard of newrelic metrics">
...
<img src="./docs/img/slack.png" width=400 alt="Message in Slack reflecting DAG status">
...
> [!NOTE]
> AWS may require your to use the alternative configuration syntax
